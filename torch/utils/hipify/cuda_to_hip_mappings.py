...
CUDA_SPECIAL_MAP = collections.OrderedDict(
    [
        ...
        ("cusparseComputeType_t", ("hipsparseComputeType_t", CONV_TYPE, API_SPECIAL)),
        ("CUSPARSE_COMPUTE_32F", ("HIPSPARSE_COMPUTE_32F", CONV_NUMERIC_LITERAL, API_SPECIAL)),
        ("CUSPARSE_COMPUTE_16F", ("HIPSPARSE_COMPUTE_16F", CONV_NUMERIC_LITERAL, API_SPECIAL)),
        ("CUSPARSE_COMPUTE_32I", ("HIPSPARSE_COMPUTE_32I", CONV_NUMERIC_LITERAL, API_SPECIAL)),
        ("CUSPARSE_COMPUTE_TF32", ("HIPSPARSE_COMPUTE_TF32", CONV_NUMERIC_LITERAL, API_SPECIAL)),
